...
@XmlRootElement(name = "Get_ODSDetails_by_Party_AgreementResponse")
public class GetODSDetailsByPartyAgreementResponse {

    @XmlElement(name = "Party", required = true)
    protected GetODSDetailsByPartyAgreementResponse.Party party;
     ...
     * @return
     *     possible object is
     *     {@link GetODSDetailsByPartyAgreementResponse.Party }
     *     
     */
    public GetODSDetailsByPartyAgreementResponse.Party getParty() {
        return party;
    }
     ...
     *     
     */
    public void setParty(GetODSDetailsByPartyAgreementResponse.Party value) {
        this.party = value;
    }
    ...
    public static class Party {
        ...
        protected List<GetODSDetailsByPartyAgreementResponse.Party.SOURCESYSTEMS> sourcesystems;
        @XmlElement(name = "PARTY_AGRES")
        protected GetODSDetailsByPartyAgreementResponse.Party.PARTYAGRES partyagres;
         ...
         * {@link GetODSDetailsByPartyAgreementResponse.Party.SOURCESYSTEMS }
         * 
         * 
         */
        public List<GetODSDetailsByPartyAgreementResponse.Party.SOURCESYSTEMS> getSOURCESYSTEMS() {
            if (sourcesystems == null) {
                sourcesystems = new ArrayList<GetODSDetailsByPartyAgreementResponse.Party.SOURCESYSTEMS>();
            }
         ...
         * @return
         *     possible object is
         *     {@link GetODSDetailsByPartyAgreementResponse.Party.PARTYAGRES }
         *     
         */
        public GetODSDetailsByPartyAgreementResponse.Party.PARTYAGRES getPARTYAGRES() {
            return partyagres;
        }
         ...
         *     
         */
        public void setPARTYAGRES(GetODSDetailsByPartyAgreementResponse.Party.PARTYAGRES value) {
        ...
        public static class PARTYAGRES {
            ...
            protected List<GetODSDetailsByPartyAgreementResponse.Party.PARTYAGRES.PARTYAGRE> partyagre;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link GetODSDetailsByPartyAgreementResponse.Party.PARTYAGRES.PARTYAGRE }
             * 
             * 
             */
            public List<GetODSDetailsByPartyAgreementResponse.Party.PARTYAGRES.PARTYAGRE> getPARTYAGRE() {
                if (partyagre == null) {
                    partyagre = new ArrayList<GetODSDetailsByPartyAgreementResponse.Party.PARTYAGRES.PARTYAGRE>();
                }
            ...
            public static class PARTYAGRE {
                ...
                @XmlElementRef(name = "CARY_ADMN_SYS_NM", namespace = "http://www.informatica.com/dis/ws/", type = JAXBElement.class)
                ...
                public void setCARYADMNSYSNM(JAXBElement<String> value) {
                    this.caryadmnsysnm = ((JAXBElement<String> ) value);
                }
        ...
        public static class SOURCESYSTEMS {
            ...
            protected List<GetODSDetailsByPartyAgreementResponse.Party.SOURCESYSTEMS.SOURCESYSTEM> sourcesystem;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link GetODSDetailsByPartyAgreementResponse.Party.SOURCESYSTEMS.SOURCESYSTEM }
             * 
             * 
             */
            public List<GetODSDetailsByPartyAgreementResponse.Party.SOURCESYSTEMS.SOURCESYSTEM> getSOURCESYSTEM() {
                if (sourcesystem == null) {
                    sourcesystem = new ArrayList<GetODSDetailsByPartyAgreementResponse.Party.SOURCESYSTEMS.SOURCESYSTEM>();
                }
